...
$(document).ready(function(){
	...
	function loginFormText() {
		...
		$.each(orText,function(){
			if ( $(this).text().length == 2 ) {
				...
				$('h4 > center:contains("Are you a registered Participant?")').html("If you've registered as a 2015<br>participant please login below.");
			}
		});
	}
	...
	var footerHomeLink = "http://www.arthritis.org/";
	var footerPrivacyLink = "http://www.arthritis.org/about-us/privacy-policy/";
	...
	$('input[name=fees]:eq(0)').addClass('walking-adult');
	$('input[name=fees]:eq(1)').addClass('walking-minor');
	$('input[name=fees]:eq(2)').addClass('cycling-adult');
	$('input[name=fees]:eq(3)').addClass('cycling-minor');
	$('input[name=fees]:eq(4)').addClass('virtual');
	$('input[name=fees]:eq(5)').addClass('general-adult');
	$('input[name=fees]:eq(6)').addClass('general-minor');
	$('input[name=fees]:eq(7)').addClass('ultimate');
	$('input[name=fees]:eq(8)').addClass('ulti-mate');
	$('input[name=fees]:eq(9)').addClass('rower-adult');
	$('input[name=fees]:eq(10)').addClass('rower-minor');
	$('input[name=fees]:eq(11)').addClass('golfer');
	$('input[name=ProductID]:eq(0)').addClass('walking-adult');
	$('input[name=ProductID]:eq(1)').addClass('walking-minor');
	$('input[name=ProductID]:eq(2)').addClass('cycling-adult');
	$('input[name=ProductID]:eq(3)').addClass('cycling-minor');
	$('input[name=ProductID]:eq(4)').addClass('virtual');
	$('input[name=ProductID]:eq(5)').addClass('general-adult');
	$('input[name=ProductID]:eq(6)').addClass('general-minor');
	$('input[name=ProductID]:eq(7)').addClass('ultimate');
	$('input[name=ProductID]:eq(8)').addClass('ulti-mate');
	$('input[name=ProductID]:eq(9)').addClass('rower-adult');
	$('input[name=ProductID]:eq(10)').addClass('rower-minor');
	$('input[name=ProductID]:eq(11)').addClass('golfer');
	...
	$('td').filter(function() { return $(this).text() ===  'Fees*'; }).closest('tr').addClass('row-fees');
	$('.walking-adult').closest('tr').addClass('row-walkingadult');
	$('.walking-minor').closest('tr').addClass('row-walkingminor');
	$('.cycling-adult').closest('tr').addClass('row-cyclingadult');
	$('.cycling-minor').closest('tr').addClass('row-cyclingminor');
	$('.virtual').closest('tr').addClass('row-virtual');
	$('.general-adult').closest('tr').addClass('row-generaladult');
	$('.general-minor').closest('tr').addClass('row-generalminor');
	$('.ultimate').closest('tr').addClass('row-ultimate');
	$('.ulti-mate').closest('tr').addClass('row-ulti-mate');
	$('.rower-adult').closest('tr').addClass('row-roweradult');
	$('.rower-minor').closest('tr').addClass('row-rowerminor');
	$('.golfer').closest('tr').addClass('row-golfer');
	$('.row-walkingadult').closest('table').addClass('regTypes');
	...
	function walkingOptions(){
	    ...
	    $('select[name=Field5791631] option[value="100 Mile Bike"]').hide();
	    $('select[name=Field5791631] option[value="77 Mile Bike"]').hide();
	    $('select[name=Field5791631] option[value="50 Mile Bike"]').hide();
	    $('select[name=Field5791631] option[value="35 Mile Bike"]').hide();
	    $('select[name=Field5791631] option[value="20 Mile Bike"]').hide();
	    $('select[name=Field5791631] option[value="20 Mile Row"]').hide();
	    $('select[name=Field5791631] option[value="15 Mile Row"]').hide();
	    $('select[name=Field5791631] option[value="10 Mile Row"]').hide();
	    $('select[name=Field5791631] option[value="5 Mile Row"]').hide();
	    ...
	    $('select[name=Field5791631] option[value="Virtual for Kyle"]').hide();
	    $('select[name=Field5791631] option[value="30k Combined Walk"]').show();
	    $('select[name=Field5791631] option[value="20k Combined Walk"]').show();
	    $('select[name=Field5791631] option[value="15k Combined Walk"]').show();
	    $('select[name=Field5791631] option[value="10k Residential Walk"]').show();
	    $('select[name=Field5791631] option[value="10k Wooded Walk"]').show();
	    $('select[name=Field5791631] option[value="5k Residential Walk"]').show();
	    $('select[name=Field5791631] option[value="5k Wooded Walk"]').show();
	...
	function cyclingOptions(){
		...
		$('.row-planComplete,.row-addInfo').show().insertAfter('.row-golfer');
	    $('select[name=Field5791631] option[value="100 Mile Bike"]').show();
	    $('select[name=Field5791631] option[value="77 Mile Bike"]').show();
	    $('select[name=Field5791631] option[value="50 Mile Bike"]').show();
	    $('select[name=Field5791631] option[value="35 Mile Bike"]').show();
	    $('select[name=Field5791631] option[value="20 Mile Bike"]').show();
	    $('select[name=Field5791631] option[value="15 Mile Row"]').hide();
	    $('select[name=Field5791631] option[value="10 Mile Row"]').hide();
	    $('select[name=Field5791631] option[value="5 Mile Row"]').hide();
	    $('select[name=Field5791631] option[value="Ultimate"]').hide();
	    ...
	    $('select[name=Field5791631] option[value="Virtual"]').hide();
	    $('select[name=Field5791631] option[value="Virtual for Kyle"]').hide();
	    $('select[name=Field5791631] option[value="30k Combined Walk"]').hide();
	    $('select[name=Field5791631] option[value="20k Combined Walk"]').hide();
	    $('select[name=Field5791631] option[value="15k Combined Walk"]').hide();
	    $('select[name=Field5791631] option[value="10k Residential Walk"]').hide();
	    $('select[name=Field5791631] option[value="10k Wooded Walk"]').hide();
	    $('select[name=Field5791631] option[value="5k Residential Walk"]').hide();
	    $('select[name=Field5791631] option[value="5k Wooded Walk"]').hide();
	...
	function ultiMateOptions(){
		...
		$('select[name=Field5791631]').val('Ultimate');
		$('.row-addfees,.row-attlFee,.row-ultimateName,.row-thursdayBus,.row-thursdayDinner,.row-fridayDouble,.row-saturdayBus').show().insertAfter('.row-golfer');
	}
	function rowerOptions(){
		...
		$('select[name=Field5791631] option[value="35 Mile Bike"]').hide();
		$('select[name=Field5791631] option[value="20 Mile Bike"]').hide();
		$('select[name=Field5791631] option[value="15 Mile Row"]').show();
		$('select[name=Field5791631] option[value="10 Mile Row"]').show();
		$('select[name=Field5791631] option[value="5 Mile Row"]').show();
		$('select[name=Field5791631] option[value="Ultimate"]').hide();
	    $('select[name=Field5791631] option[value="Golf"]').hide();
		$('select[name=Field5791631] option[value="Virtual"]').hide();
		$('select[name=Field5791631] option[value="Virtual for Kyle"]').hide();
	...
	if (document.location.href.indexOf('register.asp') > -1) {
		...
		if ($.cookie('wp_eventTypeSelect') == 'golf'){
			...
			switch(teeTime){
				case 'teetime-1':
				$('select[name=Field5935036]').val('6:00am – 10:00am');
				break;
				case 'teetime-2':
				$('select[name=Field5935036]').val('8:00am – 10:00am');
				break;
				case 'teetime-3':
				$('select[name=Field5935036]').val('10:00am – 12:00am');
				break;
				case 'teetime-4':
				$('select[name=Field5935036]').val('12:00am – 3:00am');
				break;
				default:
				$('select[name=Field5935036]').val('8:00am – 10:00am');
			}
		...
		if ($.cookie('wp_eventTypeSelect') == 'rowing'){
			if ($.cookie('wp_ageMinor') == 'no'){
				$('.rower-adult').prop('checked', true).click();
			}
			else {
				$('.rower-minor').prop('checked', true).click();
			}
			...
			switch(rowDistance){
				case 'rDistance-5':
				$('select[name=Field5791631]').val('5 Mile Row');
				break;
				case 'rDistance-10':
				$('select[name=Field5791631]').val('10 Mile Row');
				break;
				case 'rDistance-15':
				$('select[name=Field5791631]').val('15 Mile Row');
				break;
				case 'rDistance-20':
				$('select[name=Field5791631]').val('20 Mile Row');
				break;
				default:
				$('select[name=Field5791631]').val('10 Mile Row');
			}
		...
		if ($.cookie('wp_eventTypeSelect') == 'cycling'){
			if ($.cookie('wp_ageMinor') == 'no'){
				$('.cycling-adult').prop('checked', true).click();
			}
			else {
				$('.cycling-minor').prop('checked', true).click();
			}
			var cycleRoute = $.cookie('wp_cycleRoute');
			switch(cycleRoute){
				case 'cRoute-0':
				$('select[name=Field5791631]').val('20 Mile Bike');
				break;
				case 'cRoute-1':
				$('select[name=Field5791631]').val('35 Mile Bike');
				break;
				case 'cRoute-2':
				$('select[name=Field5791631]').val('50 Mile Bike');
				break;
				case 'cRoute-3':
				$('select[name=Field5791631]').val('77 Mile Bike');
				break;
				case 'cRoute-4':
				$('select[name=Field5791631]').val('100 Mile Bike');
				break;
				default:
				$('select[name=Field5791631]').val('50 Mile Bike');
			}
		...
		if ($.cookie('wp_eventTypeSelect') == 'walking'){
			if ($.cookie('wp_ageMinor') == 'no'){
				$('.walking-adult').prop('checked', true).click();
			}
			else {
				$('.walking-minor').prop('checked', true).click();
			}
			...
			switch(walkRoute){
				...
				break;
				case 'wRoute-1':
				$('select[name=Field5791631]').val('5k Residential Walk');
				break;
				case 'wRoute-2':
				$('select[name=Field5791631]').val('5k Wooded Walk');
				break;
				case 'wRoute-3':
				$('select[name=Field5791631]').val('10k Residential Walk');
				break;
				case 'wRoute-4':
				$('select[name=Field5791631]').val('10k Wooded Walk');
				break;
				case 'wRoute-5':
				$('select[name=Field5791631]').val('15k Combined Walk');
				break;
				case 'wRoute-6':
				$('select[name=Field5791631]').val('20k Combined Walk');
				break;
				case 'wRoute-7':
				$('select[name=Field5791631]').val('30k Combined Walk');
				break;
				case 'wRoute-8':
				$('select[name=Field5791631]').val('Kyle Mooney\'s Walk');
				break;
				default:
				$('select[name=Field5791631]').val('3k Audrey\'s Walk');
			}
	...
	if (document.location.href.indexOf('Register.asp') > -1) {
		...
		if (!summaryEdit){			
			...
			$("input[name=ProductID]:radio").change(function () {
				//Walking Options
				if ($("input[value=2080790]").prop('checked') == true || $("input[value=2080791]").prop('checked') == true){
					walkingOptions();
				}
				//Cycling Options
				...
				//Virtual Options
				if ($("input[value=2080788]").prop('checked') == true){
					virtualOptions();
				}
				//Ultimate Options
				if ($("input[value=2080785]").prop('checked') == true){
					ultimateOptions();
				}
				//Ulti-mate Options
				if ($("input[value=2080782]").prop('checked') == true){
					ultiMateOptions();
				}
				//Rowing Options
				if ($("input[value=2080786]").prop('checked') == true || $("input[value=2080787]").prop('checked') == true){
					rowerOptions();
				}
				//Golfing Options
